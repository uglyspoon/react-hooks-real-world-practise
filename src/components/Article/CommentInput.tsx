...
export default function CommentInput({ user, slug, dispatch }: CommentInputProps) {
  ...
  return (
    <form className='card comment-form' onSubmit={handleSubmit}>
      <div className='card-block'>
        <textarea className='form-control' placeholder='Write a comment...' value={body} onChange={(event) => setBody(event.target.value)} rows={3} />
      </div>
