...
export default function FollowUserButton({ profile, onClick, loading }: FollowUserButtonProps) {
  ...
  return (
    <button className={classNames.join(' ')} onClick={onClick} disabled={loading}>
